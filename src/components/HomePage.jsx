...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Speech<span className='text-blue-400 bold'>2Script</span></h1>
            ...
            <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className='flex specialBtn px-4 py-2 rounded-xl items-center text-base justify-between border border-blue-900 gap-4 mx-auto w-72 max-w-full my-4'>
